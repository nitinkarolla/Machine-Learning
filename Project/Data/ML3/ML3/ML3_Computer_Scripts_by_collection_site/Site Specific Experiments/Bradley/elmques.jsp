...
{{"rate1"},{"options","1 not at all","2","3","4","5","6","7","8","9 completely"}},
{{"rate2"},{"options","1 not at all","2","3","4","5","6","7","8","9 very much"}},
{{"rate3"},{"options","1 not at all","2","3","4","5","6","7","8","9 very convincing"}},
{{"rate4"},{"options","1 poorly written","2","3","4","5","6","7","8","9 very well written"}},
{{"rate5"},{"options","1 very poor and uncompelling","2","3","4","5","6","7","8","9 very good and compelling"}},
};

String[][][] instruct =
{
{{"instruct"},{"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},
{{"instructMLI"},{"choices","rat0"},{"stem","We would now like to ask you a few questions about what you just read."}},
};
...
{{"ELM_01"},{"choices","rate1"},{"stem","To what extent do you think the communication made its point effectively?"}},
{{"ELM_02"},{"choices","rate2"},{"stem","To what extent did you like the communication?"}},
{{"ELM_03"},{"choices","rate3"},{"stem","To what extent do you feel the communication was convincing?"}},
{{"ELM_04"},{"choices","rate4"},{"stem","Considering both content and style, how well written was the communication?"}},
{{"ELM_05"},{"choices","rate5"},{"stem","Would you judge the recommendation in the preceding message as being..."}},
};     

...
{{"rate1"},{"options","no effort","very little effort","some effort", "a lot of effort","I tried my hardest"}},
{{"rate2"},{"options","none","very little attention","some attention", "a lot of attention","I gave the tasks my undivided attention"}},
{{"rate3"},{"options","class requirement","extra credit","other"}},
{{"rate4"},{"options","introduction to psychology","secondary course in psychology","any class above secondary", "research methods/statistics course","other","I am not participating for a class"}},
{{"rate5"},{"options","this is my first study","about 25% done","about 50% done", "about 75% done","this is my last study","I am not participating for a class"}},
};

String[][][] instruct =
{
{{"instruct"},{"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},
{{"instructparticipate"},{"choices","rate0"},{"stem","Please answer the following questions about your participation today.  Your answers to these questions will not affect your participation or any credit you may receive in any way, so please answer honestly."}},
};
          
String[][][] participate =
{
{{"GRP"}, {"nelem","5"},{"musthave","0"},{"group","0"},{"gminmax","5.5"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},

{{"pate_01"},{"choices","rate1"},{"stem","How much effort did you put into the tasks during this experiment? "}},
{{"pate_02"},{"choices","rate2"},{"stem","How closely did you pay attention to the instructions and tasks during the experiment?"}},
{{"pate_03"},{"choices","rate3"},{"stem","Are you participating in research studies as a part of a class requirement, for extra credit, or for some other reason?"}},
{{"pate_04"},{"choices","rate4"},{"stem","If participating for a class, which best describes the class you are taking that requires/incentivises participation?"}},
{{"pate_05"},{"choices","rate5"},{"stem"," If participating for a class, how close are you to being done with your requirement?"}},
};     

                                                                          
ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
scales.add(instruct);
scales.add(participate);

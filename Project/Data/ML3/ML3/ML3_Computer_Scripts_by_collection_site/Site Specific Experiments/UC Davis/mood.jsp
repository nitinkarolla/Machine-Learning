...
{{"rate1"},{"options","Very Happy","Happy","Somewhat happy", "Neutral","Somewhat unhappy","Unhappy","Very Unhappy"}},
{{"rate2"},{"options","Very good","Good","Somewhat good", "Neutral","Somewhat bad","Bad","Very bad"}},
...
{{"instructmood"},{"choices","rate0"},{"stem","Please answer the following questions about your mood today."}},
};
          
String[][][] mood =
{
{{"GRP"}, {"nelem","2"},{"musthave","0"},{"group","0"},{"gminmax","2.2"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},

{{"mood_01"},{"choices","rate1"},{"stem","Today I generally feel"}},
{{"mood_02"},{"choices","rate2"},{"stem","Today I generally feel"}},
};     

...
{{"rate1"},{"options","never","almost never","sometimes", "fairly often","very often"}},
{{"rate2"},{"options","1 never true","2","3 sometimes true", "4","5 very often true"}},
...
{{"instructstress"},{"choices","rate0"},{"stem","Please answer the following questions about your recent stress levels."}},
};
          
String[][][] stress =
{
{{"GRP"}, {"nelem","4"},{"musthave","0"},{"group","0"},{"gminmax","4.4"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},

{{"stress_01"},{"choices","rate1"},{"stem","In the last week, how often have you felt that you were unable to control the important things in your life?"}},
{{"stress_02"},{"choices","rate1"},{"stem","In the last week, how often have you felt confident about your ability to handle your personal problems?"}},
{{"stress_03"},{"choices","rate1"},{"stem","In the last week, how often have you felt that things were going your way?"}},
{{"stress_04"},{"choices","rate1"},{"stem","In the last week, how often have you felt difficulties were piling up so high that you could not overcome them?"}},
};     

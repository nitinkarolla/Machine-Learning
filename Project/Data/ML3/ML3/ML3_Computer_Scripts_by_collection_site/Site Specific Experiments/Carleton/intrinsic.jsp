...
{{"rate1"},{"options","Never or almost never true of me","Sometimes true of me","Often true of me", "Always or almost always true of me"}},
};

String[][][] instruct =
{
{{"instruct"},{"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},
{{"instructintrinsic"},{"choices","rate0"},{"stem","Please indicate the extent to which the following statements are true of you."}},
};
          
String[][][] intrinsic =
{
{{"GRP"}, {"nelem","15"},{"musthave","0"},{"group","0"},{"gminmax","15.15"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},

{{"intrinsic_01"},{"choices","rate1"},{"stem","I enjoy tackling problems that are completely new to me."}},
{{"intrinsic_02"},{"choices","rate1"},{"stem","I enjoy trying to solve complex problems."}},
{{"intrinsic_03"},{"choices","rate1"},{"stem","The more difficult the problem, the more I enjoy trying to solve it."}},
{{"intrinsic_04"},{"choices","rate1"},{"stem","I want my work to provide me with opportunities for increasing my knowledge and skills."}},
{{"intrinsic_05"},{"choices","rate1"},{"stem","Curiosity is the driving force behind much of what I do."}},
{{"intrinsic_06"},{"choices","rate1"},{"stem","I prefer work I know I can do well over work that stretches my abilities."}},
{{"intrinsic_07"},{"choices","rate1"},{"stem","I enjoy relatively simple, straightforward tasks."}},
{{"intrinsic_08"},{"choices","rate1"},{"stem","I want to find how good I really can be at my work."}},
{{"intrinsic_09"},{"choices","rate1"},{"stem","I prefer to figure things out for myself."}},
{{"intrinsic_10"},{"choices","rate1"},{"stem","What matters most to me is enjoying what I do."}},
{{"intrinsic_11"},{"choices","rate1"},{"stem","It is important for me to have an outlet for self-expression."}},
{{"intrinsic_12"},{"choices","rate1"},{"stem","No matter what the outcome of a project, I am satisfied if I feel I gained a new experience."}},
{{"intrinsic_13"},{"choices","rate1"},{"stem","I&#8217;m more comfortable when I can set my own goals."}},
{{"intrinsic_14"},{"choices","rate1"},{"stem","I enjoy doing work that is so absorbing that I forget about everything else."}},
{{"intrinsic_15"},{"choices","rate1"},{"stem","It is important for me to be able to do what I most enjoy."}},
};     
                                                                          
ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
scales.add(instruct);
scales.add(intrinsic);

...
{{"rate1"},{"options","Extremely uncharacteristic","Uncharacteristic","Neither uncharacteristic nor characteristic", "Characteristic","Extremely characteristic"}},
{{"rate2"},{"options","1 Not relevant at all","2","3", "4","5 Very relevant"}},
...
{{"instructnfc"},{"choices","rate0"},{"stem","Please indicate the degree to which each of the following statements is characteristic of you."}},
};
          
String[][][] needforcognition =
{
{{"GRP"}, {"nelem","6"},{"musthave","0"},{"group","0"},{"gminmax","6.6"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},

{{"nfc_01"},{"choices","rate1"},{"stem","I find satisfaction in deliberating hard for long hours."}},
{{"nfc_02"},{"choices","rate1"},{"stem","Learning new ways to think doesn&#8217;t excite me very much."}},
{{"nfc_03"},{"choices","rate1"},{"stem","I like tasks that require little thought once I&#8217;ve learned them."}},
{{"nfc_04"},{"choices","rate1"},{"stem","I would prefer complex to simple problems."}},
{{"nfc_05"},{"choices","rate1"},{"stem","The notion of thinking abstractly is appealing to me."}},
{{"nfc_06"},{"choices","rate1"},{"stem","More often than not, more thinking just leads to more errors."}},
};     

                                                                          
ArrayList <String[][][]> scales = new ArrayList <String[][][]> ();
scales.add(instruct);
scales.add(needforcognition);

...
{{"rate1"},{"options","Disagree strongly","Disagree moderately","Disagree a little", "Neither agree nor disagree","Agree a little","Agree moderately","Agree strongly"}},
};

String[][][] instruct =
{
{{"instruct"},{"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},
{{"instructbig5"},{"choices","rate0"},{"stem","Here are a number of personality traits that may or may not apply to you.  Please indicate the extent to which you agree or disagree with each statement. You should rate the extent to which the pair of traits applies to you, even if one characteristic applies more strongly than the other."}},
};
          
String[][][] big5 =
{
{{"GRP"}, {"nelem","10"},{"musthave","0"},{"group","0"},{"gminmax","10.10"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},

{{"big5_01"},{"choices","rate1"},{"stem","I see myself as: Extraverted, enthusiastic. "}},
{{"big5_02"},{"choices","rate1"},{"stem","I see myself as: Critical, quarrelsome. "}},
{{"big5_03"},{"choices","rate1"},{"stem","I see myself as: Dependable, self-disciplined. "}},
{{"big5_04"},{"choices","rate1"},{"stem","I see myself as: Anxious, easily upset. "}},
{{"big5_05"},{"choices","rate1"},{"stem","I see myself as: Open to new experiences, complex. "}},
{{"big5_06"},{"choices","rate1"},{"stem","I see myself as: Reserved, quiet. "}},
{{"big5_07"},{"choices","rate1"},{"stem","I see myself as: Sympathetic, warm."}},
{{"big5_08"},{"choices","rate1"},{"stem","I see myself as: Disorganized, careless. "}},
{{"big5_09"},{"choices","rate1"},{"stem","I see myself as: Calm, emotionally stable. "}},
{{"big5_10"},{"choices","rate1"},{"stem","I see myself as: Conventional, uncreative. "}},
};     
